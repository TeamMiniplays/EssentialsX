...
public class Commandtp extends EssentialsCommand {
        ...
        switch (args.length) {
            ...
            case 1:
                ...
                if (!player.getBase().isOnline()) {
                    if (user.isAuthorized("essentials.tpoffline")) {
                        throw new TranslatableException("teleportOffline", player.getName());
                    }
            ...
            case 4:
                ...
                if (!target2.isTeleportEnabled()) {
                    throw new TranslatableException("teleportDisabled", target2.getName());
                }
            ...
            default:
                ...
                if (!target.isTeleportEnabled()) {
                    throw new TranslatableException("teleportDisabled", target.getName());
                }
                if (!toPlayer.isTeleportEnabled()) {
                    throw new TranslatableException("teleportDisabled", toPlayer.getName());
                }
                ...
                target.sendTl("teleportAtoB", user.getName(), toPlayer.getName());
    ...
    public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception {
        ...
        if (args.length == 2) {
            ...
            target.sendTl("teleportAtoB", Console.DISPLAY_NAME, toPlayer.getName());
